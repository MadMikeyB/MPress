...
<html class="lockscreen">
    <head>
        <meta charset="UTF-8">
        <title>Locked &mdash; Admin &mdash; MPress</title>
    ...
    <body>
        ...
        <div class="center">            
            ...
            <!-- User name -->
            <div class="lockscreen-name">@if ( !empty( $nickname ) ){{ $nickname }}@else{{ $username }}@endif</div>
            
            <!-- START LOCK SCREEN ITEM -->
            <div class="lockscreen-item">
                <!-- lockscreen image -->
                <div class="lockscreen-image">
                    <img src="../packages/admin/img/mike.jpg" alt="user image"/>
                </div>
                <!-- /.lockscreen-image -->
